        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsultationFee = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AvailableDays = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(4643), null, "Heart and cardiovascular system", true, "Cardiology", null, null },
                    { 2, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(6042), null, "Skin, hair, and nail conditions", true, "Dermatology", null, null },
                    { 3, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(6046), null, "Brain and nervous system", true, "Neurology", null, null },
                    { 4, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(6048), null, "Children's health", true, "Pediatrics", null, null },
                    { 5, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(6051), null, "Musculoskeletal system", true, "Orthopedics", null, null },
                    { 6, new DateTime(2026, 4, 3, 5, 5, 33, 604, DateTimeKind.Utc).AddTicks(6053), null, "General healthcare", true, "General Medicine", null, null }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Email", "FirstName", "IsActive", "LastLoginAt", "LastName", "PasswordHash", "PhoneNumber", "RefreshToken", "RefreshTokenExpiryTime", "Role", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@smarthealth.com", "System", true, null, "Administrator", "", null, null, null, "Admin", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionMedicines_PrescriptionId_MedicineId",
                table: "PrescriptionMedicines",
